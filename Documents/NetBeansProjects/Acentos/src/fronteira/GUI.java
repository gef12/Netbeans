...
public class GUI extends javax.swing.JFrame implements WindowListener {
    ...
    public void setWheel(RouletteWheel wheel) {
        this.wheel = wheel;
    }
    ...
    public void setSpin(Button spin) {
        this.spin = spin;
    }
    ...
    public Label getlBalance() {
        return lBalance;
    }

    public void setlBalance(Label lBalance) {
        this.lBalance = lBalance;
    }

    public Label getlNumberBet() {
        return lNumberBet;
    }

    public void setlNumberBet(Label lNumberBet) {
        this.lNumberBet = lNumberBet;
    }

    public Label getlBetType() {
        return lBetType;
    }

    public void setlBetType(Label lBetType) {
        this.lBetType = lBetType;
    }

    public Label getlBetAmount() {
        return lBetAmount;
    }

    public void setlBetAmount(Label lBetAmount) {
        this.lBetAmount = lBetAmount;
    }

    public Label getlBettingReport() {
        return lBettingReport;
    }

    public void setlBettingReport(Label lBettingReport) {
        this.lBettingReport = lBettingReport;
    }

    public TextField gettBalance() {
        return tBalance;
    }

    public void settBalance(TextField tBalance) {
        this.tBalance = tBalance;
    }

    public TextField gettNumberBet() {
        return tNumberBet;
    }

    public void settNumberBet(TextField tNumberBet) {
        this.tNumberBet = tNumberBet;
    }

    public TextField gettBetAmount() {
        return tBetAmount;
    }

    public void settBetAmount(TextField tBetAmount) {
        this.tBetAmount = tBetAmount;
    }
    ...
    public void setRed(JCheckBox red) {
        this.red = red;
    }
    ...
    public void setBlack(JCheckBox black) {
        this.black = black;
    }

    public JCheckBox getHigh() {
        return high;
    }

    public void setHigh(JCheckBox high) {
        this.high = high;
    }

    public JCheckBox getLow() {
        return low;
    }

    public void setLow(JCheckBox low) {
        this.low = low;
    }

    public Set<String> getSelectedCheckBoxes() {
        return selectedCheckBoxes;
    }

    public void setSelectedCheckBoxes(Set<String> selectedCheckBoxes) {
        this.selectedCheckBoxes = selectedCheckBoxes;
    }

    public int getiNumberBet() {
        return iNumberBet;
    }

    public void setiNumberBet(int iNumberBet) {
        this.iNumberBet = iNumberBet;
    }

    public TextArea gettBettingReport() {
        return tBettingReport;
    }

    public void settBettingReport(TextArea tBettingReport) {
        this.tBettingReport = tBettingReport;
    }

    public JPanel getWheelPanel() {
        return wheelPanel;
    }

    public void setWheelPanel(JPanel wheelPanel) {
